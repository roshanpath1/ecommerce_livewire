                ...
                <div class="p-4 bg-white shadow rounded-xl sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                <label class="block mb-1 text-gray-700 dark:text-white" for="country">
                                    Country
                                </label>
                                <input wire:model='country' class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none @error('country') border-red-500 @enderror" id="country" type="text">
                                </input>
                                @error('country')
                                <div class="text-sm text-red-500 ">{{$message}}</div>
                                @enderror
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4">
                <div class="p-4 bg-white shadow rounded-xl sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="flex justify-between mb-2 font-bold">
                        ...
                        <span>
                            <span class="font-semibold">{{ Number::currency($grand_total+$taxes+$shipping, 'NPR') }}</span>
