    ...
    <div class="flex items-center h-full">
        <main class="w-full max-w-md p-6 mx-auto">
            <div class="text-center">
                <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Let&rsquo;s get connected</h1>
            ...
            <div class="bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-4 sm:p-7">
                    <h2 class="block mb-2 text-2xl font-bold text-gray-800 dark:text-white">Leave Us A Message</h2>
                        ...
                        <div class="grid gap-y-4">
                            ...
                            <div>
                                <div class="flex justify-between">
                                    <label for="password" class="mb-2 text-sm dark:text-white">Write Message</label>

                                </div>
                              <div class="relative">
                                    <input type="message" id="password" wire:model="message"
                                        class="w-full text-sm border border-gray-200 rounded-lg py-9 px-9 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                        >
                                    {{-- @error('password')
                                        <div class="absolute inset-y-0 flex items-center pointer-events-none end-0 pe-3">
                                            <svg class="w-5 h-5 text-red-500" width="16" height="16"
                                ...
                                {{-- @error('password')
                                    <p class="mt-2 text-xs text-red-600 " id="email-error">
                                        {{ '“Please enter a strong password (at least 8 characters) to proceed.”' }}</p>
                                @enderror --}}
                            </div>
                            <!-- End Form Group -->
                            ...
                            <button type="submit"
                                class="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-semibold text-white bg-blue-600 border border-transparent rounded-lg gap-x-2 hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Send Message
                                </button>
                        </div>
