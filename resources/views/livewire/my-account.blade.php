                ...
                <div class="p-4 sm:p-7">
                    ...
                    <form wire:submit.prevent='updateProfile '>
                        <div class="grid gap-y-4">
                            ...
                            {{-- <button type="submit"
                                class="inline-flex items-center justify-center w-full px-4 py-3 mb-4 text-sm font-semibold text-white bg-blue-600 border border-transparent rounded-lg gap-x-2 hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Update
                                profile</button> --}}
                        </div>
